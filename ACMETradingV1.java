...
public class ACMETradingV1 {
	...
	static void processOrder() {
		...
		if (ProductThreeSelected == true) {
			System.out.print("" + ProductThree + "| " + ProductThreeQuanity + "           | " + ProductThreePrice
		...
		System.out
				.print("Do You Want To Submit or Cancel the Order : \n" + "S. Submit\nC. Cancel\n" + "Enter Option : ");
		...
		if (y == 'S') {
			...
			try {
				...
				order = order.concat("Order Number "+orderNo+"\n");
				order = order.concat("-------------------------\n");

				order = "Item Name              | Item Quanity | Item Unit Price | Item Extended Price\n";

				if (ProductOneSelected == true) {
					order = order.concat("" + ProductOne + "| " + ProductOneQuanity + "           | " + ProductOnePrice
							+ "           | " + (ProductOnePrice * ProductOneQuanity) + "\n");
				}
				if (ProductTwoSelected == true) {
					order = order.concat("" + ProductTwo + "| " + ProductTwoQuanity + "           | " + ProductTwoPrice
							+ "           | " + (ProductTwoPrice * ProductTwoQuanity) + "\n");
				}
				if (ProductThreeSelected == true) {
					order = order.concat("" + ProductThree + "| " + ProductThreeQuanity + "           | " + ProductThreePrice
							+ "           | " + (ProductThreePrice * ProductThreeQuanity) + "\n");
				}
				if (ProductFourSelected == true) {
					order = order.concat("" + ProductFour + "| " + ProductFourQuanity + "           | " + ProductFourPrice
							+ "           | " + (ProductFourPrice * ProductFourQuanity) + "\n");
				}
				if (ProductFiveSelected == true) {
					order = order.concat("" + ProductFive + "| " + ProductFiveQuanity + "           | " + ProductFivePrice
							+ "           | " + (ProductFivePrice * ProductFiveQuanity) + "\n");
				}
